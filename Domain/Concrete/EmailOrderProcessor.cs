    ...
    public class EmailOrderProcessor : IOrderProcessor
    {
        ...
        public void ProcessOrder(Entities.Cart cart, Entities.ShippingDetails shippingDetails)
        {
            using (var smtpClient = new SmtpClient())
            {
                ...
                .AppendLine("Ваше замовлення опрацьоване.")
                .AppendLine("---")
                .AppendLine("Товари:");
                ...
                foreach (var line in cart.Lines)
                {
                    ...
                    body.AppendFormat("{0} x {1} (всього: {2:c}", line.Quantity, line.Book.Name, subtotal);
                }
                ...
                body.AppendFormat("Загальна вартість: {0:c}", cart.ComputeTotalValue())
                    ...
                    .AppendLine("---")
                    .AppendFormat("Подарункова упаковка: {0}", shippingDetails.GiftWrap ? "Так" : "Ні");
